...
versionaAe=$(realpath ./versionaAe)

testdir=/tmp/versionaAe-tests
if [[ -e $testdir ]]; then
    rm -rf $testdir/*
else
    mkdir $testdir
...
$versionaAe hash-object README > hash1
git hash-object README > hash2
cmp --quiet hash1 hash2

step hash-object -w
cd left
$versionaAe hash-object -w ../README > /dev/null
cd ../right
...
step cat-file
cd left
$versionaAe cat-file blob b17d > ../file1
cd ../right
...
cd left
$versionaAe cat-file blob b17df541639ec7814a9ad274e177d9f8da1eb951 > ../file1
cd ../right
git cat-file blob b17df541639ec7814a9ad274e177d9f8da1eb951 > ../file2
cd ..
cmp file1 file2

step "Create commit (git only, nothing is tested)" #@FIXME Add versionaAe.py commit
cd left
...
cd left
$versionaAe cat-file commit HEAD > ../file1
cd ../right
...
cd left
$versionaAe cat-file tree HEAD > ../file1
cd ../right
git cat-file tree HEAD > ../file2
cd ..
cmp file1 file2

step "Add some directories and commits (git only, nothing is tested)" #@FIXME Add versionaAe.py commit
cd left
mkdir a
...
step checkout
# Git and versionaAe syntax are different here
cd left
$versionaAe checkout HEAD ../temp1
mkdir ../temp2
cd  ../temp2
...
step rev-parse
cd left
$versionaAe rev-parse HEAD  > ../file1
$versionaAe rev-parse 8a617 >> ../file1
$versionaAe rev-parse 16b65  >> ../file1
...
step "rev-parse (versionaAe redirection tester)"
#@TODO
